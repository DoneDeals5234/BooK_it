...
serve(async (req: Request) => {
  ...
  try {
    ...
    console.log(`💾 Saving native reminder to alert_reminders table for booking: ${bookingId}`);
    ...
    console.log("✅ Native reminder saved to database successfully:", reminder.id);

    return new Response(
      JSON.stringify({
        success: true,
        message: "Native reminder scheduled successfully in database",
